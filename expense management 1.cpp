...
{	system("cls");
	gotoxy(30,10);
	cout<<"Hello There, Welcome to Abhishek's Expense Management System--"<<endl;
	gotoxy(30,12);
	...
	switch(c)
	{
		case 1:
			system("cls");
			gotoxy(30,10);
			cout<<"Enter 1 to login through Admin ID"<<endl;
			gotoxy(30,12);
		...
		case 2:
			system("cls");
			gotoxy(30,10);
			cout<<"Enter 1 to login through Employee ID"<<endl;
			gotoxy(30,12);
